; ModuleID = 'H:/work/marsee101-axi-dma-read/DMA_Read_addr/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

%struct.ap_axis.37 = type { %struct.ap_int.30, %struct.ap_uint.33, %struct.ap_uint.33, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36 }
%struct.ap_int.30 = type { %struct.ap_int_base.29 }
%struct.ap_int_base.29 = type { %"class.std::locale::id.7" }
%"class.std::locale::id.7" = type { i32 }
%struct.ap_uint.33 = type { %struct.ap_int_base.0.32 }
%struct.ap_int_base.0.32 = type { %struct.ssdm_int.1.31 }
%struct.ssdm_int.1.31 = type { i4 }
%struct.ap_uint.2.36 = type { %struct.ap_int_base.3.35 }
%struct.ap_int_base.3.35 = type { %struct.ssdm_int.4.34 }
%struct.ssdm_int.4.34 = type { i1 }
%"class.hls::stream.38" = type { %struct.ap_axis.37 }
%struct.ap_uint.5.41 = type { %struct.ap_int_base.6.40 }
%struct.ap_int_base.6.40 = type { %struct.ssdm_int.7.39 }
%struct.ssdm_int.7.39 = type { i2 }
...
; [#uses=1]
declare void @"_ssdm_op_IfWrite.Stream.%struct.ap_axis.37 = type { %struct.ap_int.30, %struct.ap_uint.33, %struct.ap_uint.33, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36 }P.%struct.ap_axis.37 = type { %struct.ap_int.30, %struct.ap_uint.33, %struct.ap_uint.33, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36 }P"(%struct.ap_axis.37*, %struct.ap_axis.37*)
...
; [#uses=0]
define i32 @DMA_Read_addr(i32* %in, %"class.hls::stream.38"* %outs, i32 %frame_buffer0, i32 %frame_buffer1, i32 %frame_buffer2, %struct.ap_uint.5.41* %active_frame, %struct.ap_uint.2.36* byval align 4 %mode) nounwind {
  call void (...)* @_ssdm_op_SpecBitsMap(i32 0) nounwind, !map !4454
  call void (...)* @_ssdm_op_SpecTopModule([14 x i8]* @DMA_Read_addr.str) nounwind
  %tmp.10 = alloca %struct.ap_axis.37, align 4    ; [#uses=8 type=%struct.ap_axis.37*]
  %pix = alloca %struct.ap_axis.37, align 4       ; [#uses=7 type=%struct.ap_axis.37*]
  call void @llvm.dbg.value(metadata !{i32* %in}, i64 0, metadata !4460), !dbg !4461 ; [debug line = 19:33] [debug variable = in]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.38"* %outs}, i64 0, metadata !4462), !dbg !4463 ; [debug line = 19:70] [debug variable = outs]
  call void @llvm.dbg.value(metadata !{i32 %frame_buffer0}, i64 0, metadata !4464), !dbg !4465 ; [debug line = 20:22] [debug variable = frame_buffer0]
  call void @llvm.dbg.value(metadata !{i32 %frame_buffer1}, i64 0, metadata !4466), !dbg !4467 ; [debug line = 20:50] [debug variable = frame_buffer1]
  call void @llvm.dbg.value(metadata !{i32 %frame_buffer2}, i64 0, metadata !4468), !dbg !4469 ; [debug line = 21:22] [debug variable = frame_buffer2]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.5.41* %active_frame}, i64 0, metadata !4470), !dbg !4471 ; [debug line = 21:50] [debug variable = active_frame]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.2.36* %mode}, metadata !4472), !dbg !4473 ; [debug line = 22:20] [debug variable = mode]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.2.36* %mode, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4474 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.5.41* %active_frame, i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4476 ; [debug line = 24:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %frame_buffer0, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4477 ; [debug line = 25:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %frame_buffer1, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4478 ; [debug line = 26:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %frame_buffer2, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4479 ; [debug line = 27:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %in, i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 3072, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4480 ; [debug line = 28:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.38"* %outs, i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str6, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4481 ; [debug line = 29:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4482 ; [debug line = 30:1]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.37* %pix}, metadata !4483), !dbg !4484 ; [debug line = 32:20] [debug variable = pix]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.37* %pix}, i64 0, metadata !4485), !dbg !4488 ; [debug line = 89:10@32:23] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.37* %pix}, i64 0, metadata !4489), !dbg !4490 ; [debug line = 89:10@89:10@32:23] [debug variable = this]
  %mode.addr = getelementptr inbounds %struct.ap_uint.2.36* %mode, i32 0, i32 0, i32 0, i32 0, !dbg !4491 ; [#uses=1 type=i1*] [debug line = 1977:9@3526:0@36:9]
  %mode.load = load i1* %mode.addr, align 4, !dbg !4491 ; [#uses=2 type=i1] [debug line = 1977:9@3526:0@36:9]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %mode.load) nounwind
  br i1 %mode.load, label %2, label %1, !dbg !4495 ; [debug line = 36:9]

; <label>:1                                       ; preds = %0
  %active_frame.addr = getelementptr inbounds %struct.ap_uint.5.41* %active_frame, i32 0, i32 0, i32 0, i32 0, !dbg !4496 ; [#uses=1 type=i2*] [debug line = 1653:70@37:18]
  %active_frame.load = load i2* %active_frame.addr, align 1, !dbg !4496 ; [#uses=2 type=i2] [debug line = 1653:70@37:18]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i2 %active_frame.load) nounwind
  %tmp.2 = zext i2 %active_frame.load to i32, !dbg !4498 ; [#uses=1 type=i32] [debug line = 37:18]
  br label %3, !dbg !4500                         ; [debug line = 38:5]

; <label>:2                                       ; preds = %0
  %n.load = load i32* @n, align 4, !dbg !4501     ; [#uses=1 type=i32] [debug line = 39:9]
  %tmp = add nsw i32 %n.load, 1, !dbg !4501       ; [#uses=2 type=i32] [debug line = 39:9]
  %tmp.1 = icmp sgt i32 %tmp, 2, !dbg !4503       ; [#uses=1 type=i1] [debug line = 40:9]
  %. = select i1 %tmp.1, i32 0, i32 %tmp, !dbg !4503 ; [#uses=1 type=i32] [debug line = 40:9]
  br label %3

; <label>:3                                       ; preds = %2, %1
  %storemerge = phi i32 [ %., %2 ], [ %tmp.2, %1 ] ; [#uses=2 type=i32]
  store i32 %storemerge, i32* @n, align 4, !dbg !4498 ; [debug line = 37:18]
  switch i32 %storemerge, label %6 [
    i32 0, label %._crit_edge
    i32 1, label %4
    i32 2, label %5
  ], !dbg !4504                                   ; [debug line = 44:5]

; <label>:4                                       ; preds = %3
  br label %._crit_edge, !dbg !4505               ; [debug line = 50:13]

; <label>:5                                       ; preds = %3
  br label %._crit_edge, !dbg !4507               ; [debug line = 53:13]

; <label>:6                                       ; preds = %3
  br label %._crit_edge, !dbg !4508               ; [debug line = 56:13]

._crit_edge:                                      ; preds = %6, %5, %4, %3
  %dma_index.0.in = phi i32 [ %frame_buffer0, %6 ], [ %frame_buffer1, %5 ], [ %frame_buffer0, %4 ], [ %frame_buffer2, %3 ] ; [#uses=1 type=i32]
  %dma_index = lshr i32 %dma_index.0.in, 2, !dbg !4509 ; [#uses=1 type=i32] [debug line = 55:13]
  call void @llvm.dbg.value(metadata !{i32 %dma_index}, i64 0, metadata !4510), !dbg !4509 ; [debug line = 55:13] [debug variable = dma_index]
  %this.assign.addr = getelementptr inbounds %struct.ap_axis.37* %pix, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !4511 ; [#uses=1 type=i32*] [debug line = 172:10@62:2]
  %this.assign.addr.1 = getelementptr inbounds %struct.ap_axis.37* %pix, i32 0, i32 3, i32 0, i32 0, i32 0, !dbg !4518 ; [#uses=1 type=i1*] [debug line = 277:10@65:17]
  %this.assign.addr.2 = getelementptr inbounds %struct.ap_axis.37* %pix, i32 0, i32 4, i32 0, i32 0, i32 0, !dbg !4521 ; [#uses=1 type=i1*] [debug line = 277:10@70:17]
  %tmp.i.i.addr = getelementptr inbounds %struct.ap_axis.37* %tmp.10, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i32*] [debug line = 145:31@106:9@74:13]
  %tmp.i.i.addr.1 = getelementptr inbounds %struct.ap_axis.37* %tmp.10, i32 0, i32 1, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i4*] [debug line = 145:31@106:9@74:13]
  %this.assign.addr.3 = getelementptr inbounds %struct.ap_axis.37* %pix, i32 0, i32 1, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i4*] [debug line = 145:31@106:9@74:13]
  %tmp.i.i.addr.2 = getelementptr inbounds %struct.ap_axis.37* %tmp.10, i32 0, i32 2, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i4*] [debug line = 145:31@106:9@74:13]
  %this.assign.addr.4 = getelementptr inbounds %struct.ap_axis.37* %pix, i32 0, i32 2, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i4*] [debug line = 145:31@106:9@74:13]
  %tmp.i.i.addr.3 = getelementptr inbounds %struct.ap_axis.37* %tmp.10, i32 0, i32 3, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i1*] [debug line = 145:31@106:9@74:13]
  %tmp.i.i.addr.4 = getelementptr inbounds %struct.ap_axis.37* %tmp.10, i32 0, i32 4, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i1*] [debug line = 145:31@106:9@74:13]
  %tmp.i.i.addr.5 = getelementptr inbounds %struct.ap_axis.37* %tmp.10, i32 0, i32 5, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i1*] [debug line = 145:31@106:9@74:13]
  %this.assign.addr.5 = getelementptr inbounds %struct.ap_axis.37* %pix, i32 0, i32 5, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i1*] [debug line = 145:31@106:9@74:13]
  %tmp.i.i.addr.6 = getelementptr inbounds %struct.ap_axis.37* %tmp.10, i32 0, i32 6, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i1*] [debug line = 145:31@106:9@74:13]
  %this.assign.addr.6 = getelementptr inbounds %struct.ap_axis.37* %pix, i32 0, i32 6, i32 0, i32 0, i32 0, !dbg !4523 ; [#uses=1 type=i1*] [debug line = 145:31@106:9@74:13]
  %outs.addr = getelementptr inbounds %"class.hls::stream.38"* %outs, i32 0, i32 0, !dbg !4528 ; [#uses=1 type=%struct.ap_axis.37*] [debug line = 146:9@106:9@74:13]
  br label %7, !dbg !4529                         ; [debug line = 59:17]

; <label>:7                                       ; preds = %9, %._crit_edge
  %y = phi i32 [ 0, %._crit_edge ], [ %y.1, %9 ]  ; [#uses=4 type=i32]
  %exitcond1 = icmp eq i32 %y, 600, !dbg !4529    ; [#uses=1 type=i1] [debug line = 59:17]
  br i1 %exitcond1, label %10, label %.preheader.preheader, !dbg !4529 ; [debug line = 59:17]

.preheader.preheader:                             ; preds = %7
  %tmp.3 = mul nsw i32 %y, 800, !dbg !4513        ; [#uses=1 type=i32] [debug line = 62:2]
  br label %.preheader, !dbg !4530                ; [debug line = 60:21]

.preheader:                                       ; preds = %8, %.preheader.preheader
  %x = phi i32 [ %x.1, %8 ], [ 0, %.preheader.preheader ] ; [#uses=5 type=i32]
  %exitcond = icmp eq i32 %x, 800, !dbg !4530     ; [#uses=1 type=i1] [debug line = 60:21]
  br i1 %exitcond, label %9, label %8, !dbg !4530 ; [debug line = 60:21]

; <label>:8                                       ; preds = %.preheader
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !4531 ; [#uses=1 type=i32] [debug line = 60:35]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4532 ; [debug line = 61:1]
  %tmp.5 = add i32 %tmp.3, %dma_index, !dbg !4513 ; [#uses=1 type=i32] [debug line = 62:2]
  %tmp.6 = add i32 %tmp.5, %x, !dbg !4513         ; [#uses=1 type=i32] [debug line = 62:2]
  %in.addr = getelementptr inbounds i32* %in, i32 %tmp.6, !dbg !4513 ; [#uses=1 type=i32*] [debug line = 62:2]
  %val.assign = load volatile i32* %in.addr, align 4, !dbg !4513 ; [#uses=3 type=i32] [debug line = 62:2]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !4533), !dbg !4534 ; [debug line = 144:54@62:2] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !4535), !dbg !4536 ; [debug line = 144:54@144:75@62:2] [debug variable = val]
  store i32 %val.assign, i32* %this.assign.addr, align 4, !dbg !4511 ; [debug line = 172:10@62:2]
  %tmp.7 = or i32 %x, %y, !dbg !4538              ; [#uses=1 type=i32] [debug line = 64:13]
  %tmp.8 = icmp eq i32 %tmp.7, 0, !dbg !4538      ; [#uses=3 type=i1] [debug line = 64:13]
  store i1 %tmp.8, i1* %this.assign.addr.1, align 2, !dbg !4518 ; [debug line = 277:10@65:17]
  %tmp.9 = icmp eq i32 %x, 799, !dbg !4539        ; [#uses=3 type=i1] [debug line = 69:13]
  store i1 %tmp.9, i1* %this.assign.addr.2, align 1, !dbg !4521 ; [debug line = 277:10@70:17]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.38"* %outs}, i64 0, metadata !4540), !dbg !4542 ; [debug line = 105:48@74:13] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.37* %pix}, i64 0, metadata !4543), !dbg !4544 ; [debug line = 105:81@74:13] [debug variable = wdata]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.38"* %outs}, i64 0, metadata !4545), !dbg !4546 ; [debug line = 144:48@106:9@74:13] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.37* %pix}, i64 0, metadata !4547), !dbg !4548 ; [debug line = 144:74@106:9@74:13] [debug variable = din]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.37* %tmp.10}, metadata !4549) nounwind, !dbg !4550 ; [debug line = 145:22@106:9@74:13] [debug variable = tmp]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %val.assign) nounwind
  store i32 %val.assign, i32* %tmp.i.i.addr, align 4, !dbg !4523 ; [debug line = 145:31@106:9@74:13]
  %this.assign.load = load i4* %this.assign.addr.3, align 4, !dbg !4523 ; [#uses=2 type=i4] [debug line = 145:31@106:9@74:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %this.assign.load) nounwind
  store i4 %this.assign.load, i4* %tmp.i.i.addr.1, align 4, !dbg !4523 ; [debug line = 145:31@106:9@74:13]
  %this.assign.load.1 = load i4* %this.assign.addr.4, align 1, !dbg !4523 ; [#uses=2 type=i4] [debug line = 145:31@106:9@74:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %this.assign.load.1) nounwind
  store i4 %this.assign.load.1, i4* %tmp.i.i.addr.2, align 1, !dbg !4523 ; [debug line = 145:31@106:9@74:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %tmp.8) nounwind
  store i1 %tmp.8, i1* %tmp.i.i.addr.3, align 2, !dbg !4523 ; [debug line = 145:31@106:9@74:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %tmp.9) nounwind
  store i1 %tmp.9, i1* %tmp.i.i.addr.4, align 1, !dbg !4523 ; [debug line = 145:31@106:9@74:13]
  %this.assign.load.2 = load i1* %this.assign.addr.5, align 4, !dbg !4523 ; [#uses=2 type=i1] [debug line = 145:31@106:9@74:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %this.assign.load.2) nounwind
  store i1 %this.assign.load.2, i1* %tmp.i.i.addr.5, align 4, !dbg !4523 ; [debug line = 145:31@106:9@74:13]
  %this.assign.load.3 = load i1* %this.assign.addr.6, align 1, !dbg !4523 ; [#uses=2 type=i1] [debug line = 145:31@106:9@74:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %this.assign.load.3) nounwind
  store i1 %this.assign.load.3, i1* %tmp.i.i.addr.6, align 1, !dbg !4523 ; [debug line = 145:31@106:9@74:13]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_axis.37 = type { %struct.ap_int.30, %struct.ap_uint.33, %struct.ap_uint.33, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36 }P.%struct.ap_axis.37 = type { %struct.ap_int.30, %struct.ap_uint.33, %struct.ap_uint.33, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36, %struct.ap_uint.2.36 }P"(%struct.ap_axis.37* %outs.addr, %struct.ap_axis.37* %tmp.10) nounwind, !dbg !4528 ; [debug line = 146:9@106:9@74:13]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !4551 ; [#uses=0 type=i32] [debug line = 75:9]
  %x.1 = add nsw i32 %x, 1, !dbg !4552            ; [#uses=1 type=i32] [debug line = 60:30]
  call void @llvm.dbg.value(metadata !{i32 %x.1}, i64 0, metadata !4553), !dbg !4552 ; [debug line = 60:30] [debug variable = x]
  br label %.preheader, !dbg !4552                ; [debug line = 60:30]

; <label>:9                                       ; preds = %.preheader
  %y.1 = add nsw i32 %y, 1, !dbg !4554            ; [#uses=1 type=i32] [debug line = 59:26]
  call void @llvm.dbg.value(metadata !{i32 %y.1}, i64 0, metadata !4555), !dbg !4554 ; [debug line = 59:26] [debug variable = y]
  br label %7, !dbg !4554                         ; [debug line = 59:26]

; <label>:10                                      ; preds = %7
  ret i32 0, !dbg !4556                           ; [debug line = 78:5]
}

!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!4415, !4422, !4428, !4430, !4430, !4433, !4433, !4439, !4430, !4430, !4433, !4433, !4442, !4433, !4444, !4450, !4450, !4452, !4433, !4433, !4433, !4433, !4433, !4433, !4433, !4433, !4433, !4433}
!hls.encrypted.func = !{}
...
!2600 = metadata !{i32 786478, i32 0, metadata !883, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamI7ap_axisILi32ELi1ELi1ELi1EEElsERKS2_", metadata !884, i32 105, metadata !2222, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2221, metadata !86, i32 105} ; [ DW_TAG_subprogram ]
!2601 = metadata !{i32 786478, i32 0, metadata !883, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI7ap_axisILi32ELi1ELi1ELi1EEE5writeERKS2_", metadata !884, i32 144, metadata !2222, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2238, metadata !86, i32 144} ; [ DW_TAG_subprogram ]
!2602 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Ei", metadata !892, i32 250, metadata !2145, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2144, metadata !86, i32 250} ; [ DW_TAG_subprogram ]
!2603 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Ei", metadata !892, i32 250, metadata !2145, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2144, metadata !86, i32 250} ; [ DW_TAG_subprogram ]
!2604 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi1ELb0ELb1EEC2Ev", metadata !865, i32 1438, metadata !1877, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1876, metadata !86, i32 1438} ; [ DW_TAG_subprogram ]
!2605 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi1ELb0EEC2Ev", metadata !899, i32 3, metadata !1873, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1872, metadata !86, i32 3} ; [ DW_TAG_subprogram ]
!2606 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi1EEaSERKS0_", metadata !892, i32 276, metadata !2186, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2185, metadata !86, i32 276} ; [ DW_TAG_subprogram ]
!2607 = metadata !{i32 786478, i32 0, null, metadata !"ap_int", metadata !"ap_int", metadata !"_ZN6ap_intILi32EEC1Ei", metadata !892, i32 144, metadata !1480, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1479, metadata !86, i32 144} ; [ DW_TAG_subprogram ]
!2608 = metadata !{i32 786478, i32 0, null, metadata !"ap_int", metadata !"ap_int", metadata !"_ZN6ap_intILi32EEC2Ei", metadata !892, i32 144, metadata !1480, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1479, metadata !86, i32 144} ; [ DW_TAG_subprogram ]
!2609 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb1ELb1EEC2Ev", metadata !865, i32 1438, metadata !911, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !910, metadata !86, i32 1438} ; [ DW_TAG_subprogram ]
!2610 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi32ELb1EEC2Ev", metadata !899, i32 34, metadata !904, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !903, metadata !86, i32 34} ; [ DW_TAG_subprogram ]
!2611 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN6ap_intILi32EEaSERKS0_", metadata !892, i32 171, metadata !1521, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1520, metadata !86, i32 171} ; [ DW_TAG_subprogram ]
!2612 = metadata !{i32 786478, i32 0, null, metadata !"operator unsigned char", metadata !"operator unsigned char", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EEcvhEv", metadata !865, i32 1653, metadata !2375, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2374, metadata !86, i32 1653} ; [ DW_TAG_subprogram ]
!2613 = metadata !{i32 786478, i32 0, metadata !865, metadata !"operator==<1, false>", metadata !"operator==<1, false>", metadata !"_ZeqILi1ELb0EEbRK11ap_int_baseIXT_EXT0_EXleT_Li64EEEi", metadata !865, i32 3526, metadata !2614, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2616, null, metadata !86, i32 3526} ; [ DW_TAG_subprogram ]
...
!2617 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb1ELb1EEC1Ei", metadata !865, i32 1465, metadata !948, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !947, metadata !86, i32 1465} ; [ DW_TAG_subprogram ]
!2618 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb1ELb1EEC2Ei", metadata !865, i32 1465, metadata !948, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !947, metadata !86, i32 1465} ; [ DW_TAG_subprogram ]
!2619 = metadata !{i32 786478, i32 0, null, metadata !"operator==<32, true>", metadata !"operator==<32, true>", metadata !"_ZNK11ap_int_baseILi1ELb0ELb1EEeqILi32ELb1EEEbRKS_IXT_EXT0_EXleT_Li64EEE", metadata !865, i32 1976, metadata !2620, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !919, null, metadata !86, i32 1976} ; [ DW_TAG_subprogram ]
...
!2622 = metadata !{i32 786478, i32 0, null, metadata !"ap_axis", metadata !"ap_axis", metadata !"_ZN7ap_axisILi32ELi1ELi1ELi1EEC1Ev", metadata !888, i32 89, metadata !2194, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !2193, metadata !86, i32 89} ; [ DW_TAG_subprogram ]
!2623 = metadata !{i32 786478, i32 0, null, metadata !"ap_axis", metadata !"ap_axis", metadata !"_ZN7ap_axisILi32ELi1ELi1ELi1EEC2Ev", metadata !888, i32 89, metadata !2194, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !2193, metadata !86, i32 89} ; [ DW_TAG_subprogram ]
!2624 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Ev", metadata !892, i32 183, metadata !2111, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2110, metadata !86, i32 183} ; [ DW_TAG_subprogram ]
!2625 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Ev", metadata !892, i32 183, metadata !2111, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2110, metadata !86, i32 183} ; [ DW_TAG_subprogram ]
!2626 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi4EEC1Ev", metadata !892, i32 183, metadata !1782, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1781, metadata !86, i32 183} ; [ DW_TAG_subprogram ]
!2627 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi4EEC2Ev", metadata !892, i32 183, metadata !1782, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1781, metadata !86, i32 183} ; [ DW_TAG_subprogram ]
!2628 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi4ELb0ELb1EEC2Ev", metadata !865, i32 1438, metadata !1543, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1542, metadata !86, i32 1438} ; [ DW_TAG_subprogram ]
!2629 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi4ELb0EEC2Ev", metadata !899, i32 6, metadata !1537, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1536, metadata !86, i32 6} ; [ DW_TAG_subprogram ]
!2630 = metadata !{i32 786478, i32 0, null, metadata !"ap_int", metadata !"ap_int", metadata !"_ZN6ap_intILi32EEC1Ev", metadata !892, i32 76, metadata !1446, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1445, metadata !86, i32 76} ; [ DW_TAG_subprogram ]
!2631 = metadata !{i32 786478, i32 0, null, metadata !"ap_int", metadata !"ap_int", metadata !"_ZN6ap_intILi32EEC2Ev", metadata !892, i32 76, metadata !1446, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1445, metadata !86, i32 76} ; [ DW_TAG_subprogram ]
...
!2682 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !2684, i32 72, metadata !2685, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!2699 = metadata !{i32 786484, i32 0, metadata !875, metadata !"n", metadata !"n", metadata !"", metadata !876, i32 34, metadata !56, i32 1, i32 1, i32* @n} ; [ DW_TAG_variable ]
!2700 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !2701, i32 71, metadata !2702, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2703 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !2701, i32 74, metadata !2694, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2704 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !2701, i32 109, metadata !2694, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2705 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !2701, i32 112, metadata !2702, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2706 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !2701, i32 115, metadata !2694, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2707 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !2701, i32 118, metadata !2694, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2708 = metadata !{i32 786484, i32 0, null, metadata !"__globallocalestatus", metadata !"__globallocalestatus", metadata !"", metadata !2709, i32 76, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2710 = metadata !{i32 786484, i32 0, null, metadata !"__locale_changed", metadata !"__locale_changed", metadata !"", metadata !2709, i32 77, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2711 = metadata !{i32 786484, i32 0, null, metadata !"__initiallocinfo", metadata !"__initiallocinfo", metadata !"", metadata !2709, i32 78, metadata !2712, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2781 = metadata !{i32 786484, i32 0, null, metadata !"__initiallocalestructinfo", metadata !"__initiallocalestructinfo", metadata !"", metadata !2709, i32 79, metadata !2782, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2792 = metadata !{i32 786484, i32 0, null, metadata !"_imp____mb_cur_max", metadata !"_imp____mb_cur_max", metadata !"", metadata !2709, i32 193, metadata !149, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2793 = metadata !{i32 786484, i32 0, null, metadata !"_CRT_MT", metadata !"_CRT_MT", metadata !"", metadata !2794, i32 374, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2800 = metadata !{i32 786484, i32 0, metadata !113, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !115, i32 305, metadata !2801, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2806 = metadata !{i32 786484, i32 0, metadata !126, metadata !"_S_c_locale", metadata !"_S_c_locale", metadata !"_ZNSt6locale5facet11_S_c_localeE", metadata !115, i32 345, metadata !146, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2807 = metadata !{i32 786484, i32 0, metadata !126, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !115, i32 351, metadata !2801, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2808 = metadata !{i32 786484, i32 0, metadata !225, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !115, i32 451, metadata !81, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2809 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !115, i32 626, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2810 = metadata !{i32 786484, i32 0, metadata !2685, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 539, metadata !81, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2811 = metadata !{i32 786484, i32 0, metadata !2685, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !5, i32 540, metadata !212, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2812 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !2813, i32 611, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2917 = metadata !{i32 786484, i32 0, metadata !2831, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !2813, i32 694, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2918 = metadata !{i32 786484, i32 0, metadata !2919, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !2813, i32 1196, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3050 = metadata !{i32 786484, i32 0, metadata !3051, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !2813, i32 1538, metadata !150, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3057 = metadata !{i32 786484, i32 0, metadata !3051, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !2813, i32 1542, metadata !150, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3058 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !2813, i32 1651, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3059 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !2813, i32 1919, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3060 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !2813, i32 2257, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3061 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !2684, i32 58, metadata !3062, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3738 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !2684, i32 59, metadata !3739, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3740 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !2684, i32 60, metadata !3739, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3741 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !2684, i32 61, metadata !3739, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3742 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !2684, i32 64, metadata !3743, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!4411 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !2684, i32 65, metadata !4412, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!4413 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !2684, i32 66, metadata !4412, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!4414 = metadata !{i32 786484, i32 0, metadata !2683, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !2684, i32 67, metadata !4412, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!4415 = metadata !{i32 (i32*, %"class.hls::stream.38"*, i32, i32, i32, %struct.ap_uint.5.41*, %struct.ap_uint.2.36*)* @DMA_Read_addr, metadata !4416, metadata !4417, metadata !4418, metadata !4419, metadata !4420, metadata !4421}
...
!4422 = metadata !{null, metadata !4423, metadata !4424, metadata !4425, metadata !4426, metadata !4427, metadata !4421}
...
!4428 = metadata !{null, metadata !4423, metadata !4424, metadata !4425, metadata !4426, metadata !4429, metadata !4421}
!4429 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!4430 = metadata !{null, metadata !4423, metadata !4424, metadata !4431, metadata !4426, metadata !4432, metadata !4421}
!4431 = metadata !{metadata !"kernel_arg_type", metadata !"int"}
!4432 = metadata !{metadata !"kernel_arg_name", metadata !"val"}
!4433 = metadata !{null, metadata !4434, metadata !4435, metadata !4436, metadata !4437, metadata !4438, metadata !4421}
!4434 = metadata !{metadata !"kernel_arg_addr_space"}
!4435 = metadata !{metadata !"kernel_arg_access_qual"}
!4436 = metadata !{metadata !"kernel_arg_type"}
!4437 = metadata !{metadata !"kernel_arg_type_qual"}
!4438 = metadata !{metadata !"kernel_arg_name"}
!4439 = metadata !{null, metadata !4423, metadata !4424, metadata !4440, metadata !4426, metadata !4441, metadata !4421}
!4440 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<1> &"}
!4441 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!4442 = metadata !{null, metadata !4423, metadata !4424, metadata !4443, metadata !4426, metadata !4441, metadata !4421}
!4443 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int<32> &"}
!4444 = metadata !{null, metadata !4445, metadata !4446, metadata !4447, metadata !4448, metadata !4449, metadata !4421}
!4445 = metadata !{metadata !"kernel_arg_addr_space", i32 0, i32 0}
!4446 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none", metadata !"none"}
!4447 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<1, false> &", metadata !"int"}
!4448 = metadata !{metadata !"kernel_arg_type_qual", metadata !"", metadata !""}
!4449 = metadata !{metadata !"kernel_arg_name", metadata !"op", metadata !"op2"}
!4450 = metadata !{null, metadata !4423, metadata !4424, metadata !4431, metadata !4426, metadata !4451, metadata !4421}
!4451 = metadata !{metadata !"kernel_arg_name", metadata !"op"}
!4452 = metadata !{null, metadata !4423, metadata !4424, metadata !4453, metadata !4426, metadata !4441, metadata !4421}
!4453 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<32, true> &"}
!4454 = metadata !{metadata !4455}
!4455 = metadata !{i32 0, i32 31, metadata !4456}
!4456 = metadata !{metadata !4457}
!4457 = metadata !{metadata !"return", metadata !4458, metadata !"int", i32 0, i32 31}
!4458 = metadata !{metadata !4459}
!4459 = metadata !{i32 0, i32 1, i32 0}
!4460 = metadata !{i32 786689, metadata !875, metadata !"in", metadata !876, i32 16777235, metadata !879, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4461 = metadata !{i32 19, i32 33, metadata !875, null}
!4462 = metadata !{i32 786689, metadata !875, metadata !"outs", metadata !876, i32 33554451, metadata !881, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4463 = metadata !{i32 19, i32 70, metadata !875, null}
!4464 = metadata !{i32 786689, metadata !875, metadata !"frame_buffer0", metadata !876, i32 50331668, metadata !138, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4465 = metadata !{i32 20, i32 22, metadata !875, null}
!4466 = metadata !{i32 786689, metadata !875, metadata !"frame_buffer1", metadata !876, i32 67108884, metadata !138, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4467 = metadata !{i32 20, i32 50, metadata !875, null}
!4468 = metadata !{i32 786689, metadata !875, metadata !"frame_buffer2", metadata !876, i32 83886101, metadata !138, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4469 = metadata !{i32 21, i32 22, metadata !875, null}
!4470 = metadata !{i32 786689, metadata !875, metadata !"active_frame", metadata !876, i32 100663317, metadata !2247, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4471 = metadata !{i32 21, i32 50, metadata !875, null}
!4472 = metadata !{i32 786689, metadata !875, metadata !"mode", metadata !876, i32 117440534, metadata !1862, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4473 = metadata !{i32 22, i32 20, metadata !875, null}
!4474 = metadata !{i32 23, i32 1, metadata !4475, null}
!4475 = metadata !{i32 786443, metadata !875, i32 22, i32 25, metadata !876, i32 0} ; [ DW_TAG_lexical_block ]
!4476 = metadata !{i32 24, i32 1, metadata !4475, null}
!4477 = metadata !{i32 25, i32 1, metadata !4475, null}
!4478 = metadata !{i32 26, i32 1, metadata !4475, null}
!4479 = metadata !{i32 27, i32 1, metadata !4475, null}
!4480 = metadata !{i32 28, i32 1, metadata !4475, null}
!4481 = metadata !{i32 29, i32 1, metadata !4475, null}
!4482 = metadata !{i32 30, i32 1, metadata !4475, null}
!4483 = metadata !{i32 786688, metadata !4475, metadata !"pix", metadata !876, i32 32, metadata !887, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4484 = metadata !{i32 32, i32 20, metadata !4475, null}
!4485 = metadata !{i32 786689, metadata !2622, metadata !"this", metadata !888, i32 16777305, metadata !4486, i32 64, metadata !4487} ; [ DW_TAG_arg_variable ]
!4486 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !887} ; [ DW_TAG_pointer_type ]
!4487 = metadata !{i32 32, i32 23, metadata !4475, null}
!4488 = metadata !{i32 89, i32 10, metadata !2622, metadata !4487}
!4489 = metadata !{i32 786689, metadata !2623, metadata !"this", metadata !888, i32 16777305, metadata !4486, i32 64, metadata !4488} ; [ DW_TAG_arg_variable ]
!4490 = metadata !{i32 89, i32 10, metadata !2623, metadata !4488}
!4491 = metadata !{i32 1977, i32 9, metadata !4492, metadata !4493}
!4492 = metadata !{i32 786443, metadata !2619, i32 1976, i32 107, metadata !865, i32 21} ; [ DW_TAG_lexical_block ]
!4493 = metadata !{i32 3526, i32 0, metadata !4494, metadata !4495}
!4494 = metadata !{i32 786443, metadata !2613, i32 3526, i32 4721, metadata !865, i32 19} ; [ DW_TAG_lexical_block ]
!4495 = metadata !{i32 36, i32 9, metadata !4475, null}
!4496 = metadata !{i32 1653, i32 70, metadata !4497, metadata !4498}
!4497 = metadata !{i32 786443, metadata !2612, i32 1653, i32 68, metadata !865, i32 18} ; [ DW_TAG_lexical_block ]
!4498 = metadata !{i32 37, i32 18, metadata !4499, null}
!4499 = metadata !{i32 786443, metadata !4475, i32 36, i32 19, metadata !876, i32 1} ; [ DW_TAG_lexical_block ]
!4500 = metadata !{i32 38, i32 5, metadata !4499, null}
!4501 = metadata !{i32 39, i32 9, metadata !4502, null}
!4502 = metadata !{i32 786443, metadata !4475, i32 38, i32 10, metadata !876, i32 2} ; [ DW_TAG_lexical_block ]
!4503 = metadata !{i32 40, i32 9, metadata !4502, null}
!4504 = metadata !{i32 44, i32 5, metadata !4475, null}
!4505 = metadata !{i32 50, i32 13, metadata !4506, null}
!4506 = metadata !{i32 786443, metadata !4475, i32 44, i32 15, metadata !876, i32 3} ; [ DW_TAG_lexical_block ]
!4507 = metadata !{i32 53, i32 13, metadata !4506, null}
!4508 = metadata !{i32 56, i32 13, metadata !4506, null}
!4509 = metadata !{i32 55, i32 13, metadata !4506, null}
!4510 = metadata !{i32 786688, metadata !4475, metadata !"dma_index", metadata !876, i32 33, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4511 = metadata !{i32 172, i32 10, metadata !4512, metadata !4513}
!4512 = metadata !{i32 786443, metadata !2611, i32 171, i32 90, metadata !892, i32 17} ; [ DW_TAG_lexical_block ]
!4513 = metadata !{i32 62, i32 2, metadata !4514, null}
!4514 = metadata !{i32 786443, metadata !4515, i32 60, i32 34, metadata !876, i32 7} ; [ DW_TAG_lexical_block ]
!4515 = metadata !{i32 786443, metadata !4516, i32 60, i32 9, metadata !876, i32 6} ; [ DW_TAG_lexical_block ]
!4516 = metadata !{i32 786443, metadata !4517, i32 59, i32 30, metadata !876, i32 5} ; [ DW_TAG_lexical_block ]
!4517 = metadata !{i32 786443, metadata !4475, i32 59, i32 5, metadata !876, i32 4} ; [ DW_TAG_lexical_block ]
!4518 = metadata !{i32 277, i32 10, metadata !4519, metadata !4520}
!4519 = metadata !{i32 786443, metadata !2606, i32 276, i32 92, metadata !892, i32 13} ; [ DW_TAG_lexical_block ]
!4520 = metadata !{i32 65, i32 17, metadata !4514, null}
!4521 = metadata !{i32 277, i32 10, metadata !4519, metadata !4522}
!4522 = metadata !{i32 70, i32 17, metadata !4514, null}
!4523 = metadata !{i32 145, i32 31, metadata !4524, metadata !4525}
!4524 = metadata !{i32 786443, metadata !2601, i32 144, i32 79, metadata !884, i32 9} ; [ DW_TAG_lexical_block ]
!4525 = metadata !{i32 106, i32 9, metadata !4526, metadata !4527}
!4526 = metadata !{i32 786443, metadata !2600, i32 105, i32 88, metadata !884, i32 8} ; [ DW_TAG_lexical_block ]
!4527 = metadata !{i32 74, i32 13, metadata !4514, null}
!4528 = metadata !{i32 146, i32 9, metadata !4524, metadata !4525}
!4529 = metadata !{i32 59, i32 17, metadata !4517, null}
!4530 = metadata !{i32 60, i32 21, metadata !4515, null}
!4531 = metadata !{i32 60, i32 35, metadata !4514, null}
!4532 = metadata !{i32 61, i32 1, metadata !4514, null}
!4533 = metadata !{i32 786689, metadata !2607, metadata !"val", metadata !892, i32 33554576, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4534 = metadata !{i32 144, i32 54, metadata !2607, metadata !4513}
!4535 = metadata !{i32 786689, metadata !2608, metadata !"val", metadata !892, i32 33554576, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4536 = metadata !{i32 144, i32 54, metadata !2608, metadata !4537}
!4537 = metadata !{i32 144, i32 75, metadata !2607, metadata !4513}
!4538 = metadata !{i32 64, i32 13, metadata !4514, null}
!4539 = metadata !{i32 69, i32 13, metadata !4514, null}
!4540 = metadata !{i32 786689, metadata !2600, metadata !"this", metadata !884, i32 16777321, metadata !4541, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4541 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !882} ; [ DW_TAG_pointer_type ]
!4542 = metadata !{i32 105, i32 48, metadata !2600, metadata !4527}
!4543 = metadata !{i32 786689, metadata !2600, metadata !"wdata", metadata !884, i32 33554537, metadata !2224, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4544 = metadata !{i32 105, i32 81, metadata !2600, metadata !4527}
!4545 = metadata !{i32 786689, metadata !2601, metadata !"this", metadata !884, i32 16777360, metadata !4541, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4546 = metadata !{i32 144, i32 48, metadata !2601, metadata !4525}
!4547 = metadata !{i32 786689, metadata !2601, metadata !"din", metadata !884, i32 33554576, metadata !2224, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4548 = metadata !{i32 144, i32 74, metadata !2601, metadata !4525}
!4549 = metadata !{i32 786688, metadata !4524, metadata !"tmp", metadata !884, i32 145, metadata !887, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4550 = metadata !{i32 145, i32 22, metadata !4524, metadata !4525}
!4551 = metadata !{i32 75, i32 9, metadata !4514, null}
!4552 = metadata !{i32 60, i32 30, metadata !4515, null}
!4553 = metadata !{i32 786688, metadata !4515, metadata !"x", metadata !876, i32 60, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4554 = metadata !{i32 59, i32 26, metadata !4517, null}
!4555 = metadata !{i32 786688, metadata !4517, metadata !"y", metadata !876, i32 59, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4556 = metadata !{i32 78, i32 5, metadata !4475, null}
